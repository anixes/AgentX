...
## Corpus Check
- 114 files · ~91,823 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 944 nodes · 1321 edges · 157 communities detected
...
- `Unified Swarm Engine replacing BatonOrchestrator, SwarmController, and SwarmLaun` --uses--> `UnifiedGateway`  [INFERRED]
  scripts\swarm_engine.py → scripts\core\gateway.py
...
Cohesion: 0.07
Nodes (12): detectCalls(), detectLanguage(), hashContent(), lineOf(), parseFile(), parseJSON(), parsePython(), parseTSJS() (+4 more)
...
Cohesion: 0.07
Nodes (29): append_baton_history(), now_iso(), The worker entry point.     Reads a baton file, executes the assigned task, and, save_baton(), work(), decide(), DecisionEngine, LLM-assisted decision engine for AgentX.     Determines the best execution path (+21 more)
...
Cohesion: 0.15
Nodes (17): build_chain(), compose_skills(), _inject_context(), _log_skill_status(), _max_risk(), agentx/skills/skill_composer.py ================================ Phase 9 — Gap 2, Heuristically split a multi-step objective into ordered sub-objectives.      "fe, Decompose objective into sub-objectives and recommend a skill for each.      Ret (+9 more)

### Community 14 - "Community 14"
Cohesion: 0.2
Nodes (15): extract_tags(), get_feedback_stats(), get_objective_hash(), get_recent_decisions(), get_similar_decisions(), init_feedback_db(), log_decision_outcome(), agentx/decision/feedback.py ========================== Phase 10 — Decision Feedb (+7 more)
...
Cohesion: 0.26
Nodes (5): append_baton_history(), now_iso(), Unified Swarm Engine replacing BatonOrchestrator, SwarmController, and SwarmLaun, SwarmEngine, write_baton()
...
Cohesion: 0.43
Nodes (6): check_rules(), create_rule(), extract_rule_from_failures(), init_rules_db(), Deterministic rule engine that overrides decisions based on exact matches or key, Automatically called when repeated failures occur.     Generates a deterministic
...
Cohesion: 1.0
Nodes (1): Retrieve past decisions with similar intent using tag matching.
...
## Knowledge Gaps
- **187 isolated node(s):** `AgentX — Unified CLI Entry Point ================================= Usage:   agen`, `Start the interactive SafeShell TUI.`, `Launch API Bridge (background) + Dashboard dev server.`, `Delegate an objective to the SwarmEngine (auto-picks mode).`, `Print a concise dashboard of swarm health.` (+182 more)
...
- **Thin community `Community 88`** (1 nodes): `Print a concise dashboard of swarm health.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 89`** (1 nodes): `Run system health checks and diagnostics.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 94`** (1 nodes): `Interactive wizard to configure AI provider, key, and model.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 95`** (1 nodes): `Run system health checks and diagnostics.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 96`** (1 nodes): `Run system health checks and diagnostics.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 97`** (1 nodes): `Manage AJA's structured secretary memory.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 98`** (1 nodes): `Manage AJA outbound communication drafts.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 99`** (1 nodes): `Run AJA executive reviews.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 100`** (1 nodes): `Manage the Worker Capability Registry.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 101`** (1 nodes): `Interactive wizard to configure AI provider, key, and model.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 102`** (1 nodes): `Retrieve recent decision outcomes for a specific objective hash.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 103`** (1 nodes): `Retrieve past decisions with similar intent using tag matching.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 104`** (1 nodes): `Calculate success/failure stats for an objective.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 105`** (1 nodes): `Print a concise dashboard of swarm health.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 106`** (1 nodes): `Run system health checks and diagnostics.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 107`** (1 nodes): `Manage AJA's structured secretary memory.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 108`** (1 nodes): `Manage AJA outbound communication drafts.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 109`** (1 nodes): `Run AJA executive reviews.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 110`** (1 nodes): `Manage the Worker Capability Registry.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 111`** (1 nodes): `Interactive wizard to configure AI provider, key, and model.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 112`** (1 nodes): `Print a concise dashboard of swarm health.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 113`** (1 nodes): `Manage the Worker Capability Registry.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 118`** (1 nodes): `Interactive wizard to configure AI provider, key, and model.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 119`** (1 nodes): `Normalize and hash the objective string.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 120`** (1 nodes): `Record the outcome of a decision.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 121`** (1 nodes): `Retrieve recent decision outcomes for a specific objective hash.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 122`** (1 nodes): `Calculate success/failure stats for an objective.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 123`** (1 nodes): `Execute a chain of skills sequentially with shared context.      Parameters`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 124`** (1 nodes): `Print a concise dashboard of swarm health.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 125`** (1 nodes): `Run system health checks and diagnostics.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 126`** (1 nodes): `Manage AJA's structured secretary memory.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 127`** (1 nodes): `Manage AJA outbound communication drafts.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 128`** (1 nodes): `Run AJA executive reviews.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 129`** (1 nodes): `Interactive wizard to configure AI provider, key, and model.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 130`** (1 nodes): `Interactive wizard to configure AI provider, key, and model.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 131`** (1 nodes): `Print a concise dashboard of swarm health.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 132`** (1 nodes): `Manage AJA's structured secretary memory.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 133`** (1 nodes): `Manage AJA outbound communication drafts.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 134`** (1 nodes): `Run AJA executive reviews.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 135`** (1 nodes): `Manage the Worker Capability Registry.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 136`** (1 nodes): `Interactive wizard to configure AI provider, key, and model.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 137`** (1 nodes): `Print a concise dashboard of swarm health.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 138`** (1 nodes): `Run system health checks and diagnostics.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 139`** (1 nodes): `Manage AJA's structured secretary memory.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 140`** (1 nodes): `Manage AJA outbound communication drafts.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 141`** (1 nodes): `Run AJA executive reviews.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 142`** (1 nodes): `Manage the Worker Capability Registry.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 143`** (1 nodes): `Interactive wizard to configure AI provider, key, and model.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 144`** (1 nodes): `Print a concise dashboard of swarm health.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 145`** (1 nodes): `Run system health checks and diagnostics.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 146`** (1 nodes): `Manage AJA's structured secretary memory.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 147`** (1 nodes): `Manage AJA outbound communication drafts.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 148`** (1 nodes): `Run AJA executive reviews.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 149`** (1 nodes): `Record error details on a task and set its status.     error_type: 'RETRYABLE' o`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 150`** (1 nodes): `Delete COMPLETED / FAILED_PERMANENT tasks older than ttl_days. Returns rows dele`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 151`** (1 nodes): `Claude Logic: Auto-detect provider or use override.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 152`** (1 nodes): `Enhanced Proxy with Claude-inspired Fail-Open and Auto-Routing.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 153`** (1 nodes): `Project Capabilities`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 154`** (1 nodes): `External AI Providers`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 155`** (1 nodes): `Project Post-Mortem`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 156`** (1 nodes): `Sandbox Environment`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `CommandStripper` connect `Community 0` to `Community 4`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Why does `UnifiedGateway` connect `Community 4` to `Community 18`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `An integrated 'Safe Shell' that inspects commands using Claude-style stripping` connect `Community 4` to `Community 0`?**
...
- **Are the 19 inferred relationships involving `UnifiedGateway` (e.g. with `DecisionEngine` and `LLM-assisted decision engine for AgentX.     Determines the best execution path`) actually correct?**
  _`UnifiedGateway` has 19 INFERRED edges - model-reasoned connections that need verification._
